...
const Banner = () => {
  ...
  return (
    <div className='max-w-4xl mx-auto  text-gray-100  pt-32'>
      <div className="mx-4 grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 order-2">
      <div className='w-11/12 pt-4 text-center sm:text-left'>
          ...
          <img src={hero} alt="banner" className='order-first md:order-last'/>
     </div>
    </div>
  )
}
